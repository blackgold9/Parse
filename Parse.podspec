Pod::Spec.new do |s|
  ...
  s.source = { :git => 'https://github.com/fictorial/Parse.git', :tag => '1.1.0' }
  ...
  s.frameworks = 'AudioToolbox', 'CFNetwork', 'SystemConfiguration', 'MobileCoreServices', 'CoreGraphics', 'Security', 'QuartzCore', 'Parse', 'sqlite3'
